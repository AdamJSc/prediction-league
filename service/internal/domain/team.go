...
func Teams() models.TeamCollection {
	return map[string]models.Team{
		"AFC": {
			ID:        "AFC",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 57},
			Name:      "Arsenal",
			ShortName: "Arsenal",
		...
		"AFCB": {
			ID:        "AFCB",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 1044},
			Name:      "Bournemouth",
			ShortName: "Cherries",
		...
		"AVFC": {
			ID:        "AVFC",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 58},
			Name:      "Aston Villa",
			ShortName: "Villa",
		...
		"BHAFC": {
			ID:        "BHAFC",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 397},
		...
		"CFC": {
			ID:        "CFC",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 61},
			Name:      "Chelsea",
			ShortName: "Chelsea",
		...
		"CPFC": {
			ID:        "CPFC",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 354},
			Name:      "Crystal Palace",
			ShortName: "Palace",
		...
		"EFC": {
			ID:        "EFC",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 62},
			Name:      "Everton",
			ShortName: "Everton",
		...
		"LFC": {
			ID:        "LFC",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 64},
			Name:      "Liverpool",
			ShortName: "Liverpool",
		...
		"LCFC": {
			ID:        "LCFC",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 338},
			Name:      "Leicester City",
			ShortName: "Leicester",
		...
		"MCFC": {
			ID:        "MCFC",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 65},
		...
		"MUFC": {
			ID:        "MUFC",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 66},
		...
		"NCFC": {
			ID:        "NCFC",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 68},
			Name:      "Norwich City",
			ShortName: "Norwich",
		...
		"NUFC": {
			ID:        "NUFC",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 67},
		...
		"SUFC": {
			ID:        "SUFC",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 356},
		...
		"SFC": {
			ID:        "SFC",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 340},
			Name:      "Southampton",
			ShortName: "Saints",
		...
		"THFC": {
			ID:        "THFC",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 73},
		...
		"WFC": {
			ID:        "WFC",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 346},
			Name:      "Watford",
			ShortName: "Watford",
		...
		"WWFC": {
			ID:        "WWFC",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 76},
		...
		"WHUFC": {
			ID:        "WHUFC",
			ClientID:  models.FootballDataOrgTeamIdentifier{TeamID: 563},
